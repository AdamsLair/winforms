...
namespace AdamsLair.WinForms.PropertyEditing.Templates
{
	public class BitmaskEditorTemplate : EditorTemplate, IPopupControlHost
	{
		...
		public void OnPaint(PaintEventArgs e, bool enabled, bool multiple)
		{
			...
			ControlRenderer.DrawComboBox(e.Graphics, this.rect, comboState, this.bitmaskStr);
		}
		...
		public void ShowDropDown()
		{
			...
			Size dropDownSize = new Size(
				...
				Math.Min(
					this.dropdownHeight, 
					(this.dropdown.ItemHeight * this.dropdown.Items.Count()) + this.dropdown.Margin.Vertical));
